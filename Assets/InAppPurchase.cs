...
// one of the existing Survival Shooter scripts.
    ...
    void Start()
        ...
        builder.AddProduct(kProductIDNonConsumable1, ProductType.NonConsumable);
        builder.AddProduct(kProductIDNonConsumable2, ProductType.NonConsumable);
        ...
        public void BuyNonConsumable_removeads()
        {
            // Buy the non-consumable product using its general identifier. Expect a response either 
            // through ProcessPurchase or OnPurchaseFailed asynchronously.
            BuyProductID(kProductIDNonConsumable);
        }
    public void BuyNonConsumable_unlockallvehicles()
    {
        // Buy the non-consumable product using its general identifier. Expect a response either 
        // through ProcessPurchase or OnPurchaseFailed asynchronously.
        BuyProductID(kProductIDNonConsumable);
    }
    public void BuyNonConsumable_unlockalllevels()
    {
        // Buy the non-consumable product using its general identifier. Expect a response either 
        // through ProcessPurchase or OnPurchaseFailed asynchronously.
        BuyProductID(kProductIDNonConsumable);
    ...
    public void BuySubscription()
        ...
        else if (String.Equals(args.purchasedProduct.definition.id, kProductIDNonConsumable1, StringComparison.Ordinal))
        {
            Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            // TODO: The non-consumable item has been successfully purchased, grant this item to the player.
            UnlockAllVehiclesEvent();
        }
            else if (String.Equals(args.purchasedProduct.definition.id, kProductIDNonConsumable2, StringComparison.Ordinal))
        {
            Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            // TODO: The non-consumable item has been successfully purchased, grant this item to the player.
            UnlockAllLevelsEvent();
        }
